...
exports.pyFn = exports.findUpperNonCommentLineZero = void 0;
...
const findUpperNonCommentLineZero = (pyText, currLineZero, lMap) => {
...
exports.findUpperNonCommentLineZero = findUpperNonCommentLineZero;
const pyFn = (pythonTextInput, editorInfo) => {
    ...
    // console.time("py");
    const pyTokens = pyParser.getAllTokens(pythonText);
    // console.timeEnd("py");
    ...
    let blockOpenersClosers = [];
    // console.log("indentsAndDedents:", indentsAndDedents);
    indentsAndDedents.map((x) => {
        if (x.type === typeS) {
            const realLineZero = exports.findUpperNonCommentLineZero(pythonText, x.line - 1, lMap);
            ...
            let realLineZero = exports.findUpperNonCommentLineZero(pythonText, x.line - 1, lMap) + 1;
...
*/
//# sourceMappingURL=python-algo.js.map