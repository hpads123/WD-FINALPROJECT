...
(function () {
    ...
    (function () {
        class Alias extends Node {
            constructor(to, from, keyword_l, expression_l) {
                super();
                this.to = to;
                this.from = from;
        ...
        class And extends Node {
            constructor(lhs, rhs, operator_l, expression_l) {
                super();
                this.lhs = lhs;
                this.rhs = rhs;
        ...
        class AndAsgn extends Node {
            constructor(recv, value, operator_l, expression_l) {
                super();
                this.recv = recv;
                this.value = value;
                this.operator_l = operator_l;
        ...
        class Args extends Node {
            constructor(args, expression_l, begin_l, end_l) {
                super();
                this.args = args;
                this.expression_l = expression_l;
        ...
        class Array extends Node {
            constructor(elements, begin_l, end_l, expression_l) {
                super();
        ...
        class Begin extends Node {
            constructor(statements, begin_l, end_l, expression_l) {
                super();
        ...
        class Block extends Node {
            constructor(call, args, body, begin_l, end_l, expression_l) {
                super();
                this.call = call;
                this.args = args;
                this.body = body;
        ...
        class Blockarg extends Node {
            constructor(name, operator_l, name_l, expression_l) {
                super();
                this.name = name;
                this.operator_l = operator_l;
                this.name_l = name_l;
        ...
        class BlockPass extends Node {
            constructor(value, operator_l, expression_l) {
                super();
                this.value = value;
                this.operator_l = operator_l;
                this.expression_l = expression_l;
        ...
        class Break extends Node {
            constructor(args, keyword_l, expression_l) {
                super();
                this.args = args;
                this.keyword_l = keyword_l;
                this.expression_l = expression_l;
        ...
        class Case extends Node {
            constructor(expr, when_bodies, else_body, keyword_l, else_l, end_l, expression_l) {
                super();
                this.expr = expr;
        ...
        class CaseMatch extends Node {
            constructor(expr, in_bodies, else_body, keyword_l, else_l, end_l, expression_l) {
                super();
                this.expr = expr;
        ...
        class Casgn extends Node {
            constructor(scope, name, value, double_colon_l, name_l, operator_l, expression_l) {
                super();
                this.scope = scope;
                this.name = name;
                this.value = value;
        ...
        class Class extends Node {
            constructor(name, superclass, body, keyword_l, operator_l, end_l, expression_l) {
                super();
                this.name = name;
        ...
        class Const extends Node {
            constructor(scope, name, double_colon_l, name_l, expression_l) {
                super();
                this.scope = scope;
                this.name = name;
                this.double_colon_l = double_colon_l;
        ...
        class ConstPattern extends Node {
            constructor(const_, pattern, begin_l, end_l, expression_l) {
                super();
                this.const_ = const_;
        ...
        class CSend extends Node {
            constructor(recv, method_name, args, dot_l, selector_l, begin_l, end_l, operator_l, expression_l) {
                super();
                this.recv = recv;
        ...
        class Cvasgn extends Node {
            constructor(name, value, name_l, operator_l, expression_l) {
                super();
                this.name = name;
                this.value = value;
                this.name_l = name_l;
        ...
        class Def extends Node {
            constructor(name, args, body, keyword_l, name_l, end_l, assignment_l, expression_l) {
                super();
                this.name = name;
                this.args = args;
                this.body = body;
        ...
        class Defined extends Node {
            constructor(value, keyword_l, begin_l, end_l, expression_l) {
                super();
                this.value = value;
                this.keyword_l = keyword_l;
                this.begin_l = begin_l;
        ...
        class Defs extends Node {
            constructor(definee, name, args, body, keyword_l, operator_l, name_l, assignment_l, end_l, expression_l) {
                super();
        ...
        class Dstr extends Node {
            constructor(parts, begin_l, end_l, expression_l) {
                super();
                this.parts = parts;
                this.begin_l = begin_l;
                this.end_l = end_l;
        ...
        class EFlipFlop extends Node {
            constructor(left, right, operator_l, expression_l) {
                super();
                this.left = left;
                this.right = right;
                this.operator_l = operator_l;
        ...
        class Ensure extends Node {
            constructor(body, ensure, keyword_l, expression_l) {
                super();
                this.body = body;
                this.ensure = ensure;
                this.keyword_l = keyword_l;
        ...
        class For extends Node {
            constructor(iterator, iteratee, body, keyword_l, operator_l, begin_l, end_l, expression_l) {
                super();
        ...
        class Hash extends Node {
            constructor(pairs, begin_l, end_l, expression_l) {
                super();
                this.pairs = pairs;
                this.begin_l = begin_l;
                this.end_l = end_l;
        ...
        class Heredoc extends Node {
            constructor(parts, heredoc_body_l, heredoc_end_l, expression_l) {
                super();
                this.parts = parts;
        ...
        class If extends Node {
            constructor(cond, if_true, if_false, keyword_l, begin_l, else_l, end_l, expression_l) {
                super();
                this.cond = cond;
        ...
        class IfGuard extends Node {
            constructor(cond, keyword_l, expression_l) {
                super();
                this.cond = cond;
                this.keyword_l = keyword_l;
                this.expression_l = expression_l;
        ...
        class IfMod extends Node {
            constructor(cond, if_true, if_false, keyword_l, expression_l) {
                super();
                this.cond = cond;
                this.if_true = if_true;
                this.if_false = if_false;
        ...
        class IfTernary extends Node {
            constructor(cond, if_true, if_false, question_l, colon_l, expression_l) {
                super();
                this.cond = cond;
                this.if_true = if_true;
                this.if_false = if_false;
        ...
        class Index extends Node {
            constructor(recv, indexes, begin_l, end_l, expression_l) {
                super();
                this.recv = recv;
        ...
        class IndexAsgn extends Node {
            constructor(recv, indexes, value, begin_l, end_l, operator_l, expression_l) {
                super();
                this.recv = recv;
                this.indexes = indexes;
                this.value = value;
        ...
        class InPattern extends Node {
            constructor(pattern, guard, body, keyword_l, begin_l, expression_l) {
                super();
                this.pattern = pattern;
                this.guard = guard;
                this.body = body;
        ...
        class Kwarg extends Node {
            constructor(name, name_l, expression_l) {
                super();
                this.name = name;
                this.name_l = name_l;
                this.expression_l = expression_l;
        ...
        class Kwargs extends Node {
            constructor(pairs, expression_l) {
                super();
                this.pairs = pairs;
                this.expression_l = expression_l;
            }
        ...
        class Kwnilarg extends Node {
            constructor(name_l, expression_l) {
                super();
                this.name_l = name_l;
                this.expression_l = expression_l;
            }
        ...
        class Kwoptarg extends Node {
            constructor(name, default_, name_l, expression_l) {
                super();
                this.name = name;
        ...
        class MatchAs extends Node {
            constructor(value, as, operator_l, expression_l) {
                super();
                this.value = value;
                this.as = as;
                this.operator_l = operator_l;
        ...
        class MatchNilPattern extends Node {
            constructor(operator_l, name_l, expression_l) {
                super();
                this.operator_l = operator_l;
                this.name_l = name_l;
                this.expression_l = expression_l;
        ...
        class MatchPattern extends Node {
            constructor(value, pattern, operator_l, expression_l) {
                super();
                this.value = value;
                this.pattern = pattern;
                this.operator_l = operator_l;
        ...
        class MatchRest extends Node {
            constructor(name, operator_l, expression_l) {
                super();
                this.name = name;
                this.operator_l = operator_l;
                this.expression_l = expression_l;
        ...
        class MatchWithLvasgn extends Node {
            constructor(re, value, operator_l, expression_l) {
                super();
                this.re = re;
                this.value = value;
                this.operator_l = operator_l;
        ...
        class Mlhs extends Node {
            constructor(items, begin_l, end_l, expression_l) {
                super();
                this.items = items;
                this.begin_l = begin_l;
                this.end_l = end_l;
        ...
        class Module extends Node {
            constructor(name, body, keyword_l, end_l, expression_l) {
                super();
                this.name = name;
                this.body = body;
                this.keyword_l = keyword_l;
        ...
        class Numblock extends Node {
            constructor(call, numargs, body, begin_l, end_l, expression_l) {
                super();
                this.call = call;
        ...
        class OpAsgn extends Node {
            constructor(recv, operator, value, operator_l, expression_l) {
                super();
                this.recv = recv;
        ...
        class Optarg extends Node {
            constructor(name, default_, name_l, operator_l, expression_l) {
                super();
                this.name = name;
                this.default_ = default_;
                this.name_l = name_l;
        ...
        class Pair extends Node {
            constructor(key, value, operator_l, expression_l) {
                super();
                this.key = key;
                this.value = value;
                this.operator_l = operator_l;
        ...
        class Pin extends Node {
            constructor(var_, selector_l, expression_l) {
                super();
                this.var_ = var_;
                this.selector_l = selector_l;
                this.expression_l = expression_l;
        ...
        class Postexe extends Node {
            constructor(body, keyword_l, begin_l, end_l, expression_l) {
                super();
                this.body = body;
                this.keyword_l = keyword_l;
                this.begin_l = begin_l;
        ...
        class Procarg0 extends Node {
            constructor(args, begin_l, end_l, expression_l) {
                super();
                this.args = args;
                this.begin_l = begin_l;
                this.end_l = end_l;
        ...
        class Regexp extends Node {
            constructor(parts, options, begin_l, end_l, expression_l) {
                super();
                this.parts = parts;
        ...
        class RegOpt extends Node {
            constructor(options, expression_l) {
                super();
                this.options = options;
                this.expression_l = expression_l;
            }
        ...
        class Rescue extends Node {
            constructor(body, rescue_bodies, else_, else_l, expression_l) {
                super();
                this.body = body;
        ...
        class RescueBody extends Node {
            constructor(exc_list, exc_var, body, keyword_l, assoc_l, begin_l, expression_l) {
                super();
        ...
        class SClass extends Node {
            constructor(expr, body, keyword_l, operator_l, end_l, expression_l) {
                super();
                this.expr = expr;
                this.body = body;
                this.keyword_l = keyword_l;
        ...
        class Str extends Node {
            constructor(value, begin_l, end_l, expression_l) {
                super();
                this.value = value;
                this.begin_l = begin_l;
                this.end_l = end_l;
        ...
        class Super extends Node {
            constructor(args, keyword_l, begin_l, end_l, expression_l) {
                super();
                this.args = args;
                this.keyword_l = keyword_l;
                this.begin_l = begin_l;
        ...
        class Sym extends Node {
            constructor(name, begin_l, end_l, expression_l) {
                super();
                this.name = name;
                this.begin_l = begin_l;
                this.end_l = end_l;
        ...
        class Undef extends Node {
            constructor(names, keyword_l, expression_l) {
                super();
                this.names = names;
                this.keyword_l = keyword_l;
                this.expression_l = expression_l;
        ...
        class Until extends Node {
            constructor(cond, body, keyword_l, begin_l, end_l, expression_l) {
                super();
                this.cond = cond;
                this.body = body;
                this.keyword_l = keyword_l;
        ...
        class UntilPost extends Node {
            constructor(cond, body, keyword_l, expression_l) {
                super();
                this.cond = cond;
                this.body = body;
                this.keyword_l = keyword_l;
        ...
        class When extends Node {
            constructor(patterns, body, keyword_l, begin_l, expression_l) {
                super();
    ...
    (function () {
        ...
        class AmbiguousOperator extends DiagnsoticMessage {
            constructor(operator, interpreted_as) {
                super();
                this.operator = operator;
    ...
    */
    ...
    module.exports.__wbg_call_8a893cac80deeb51 = function () {
    ...
    const aaaqqq = require('path').resolve(__dirname);
    // console.log(aaaqqq);
    // const path = require('path').join(__dirname, 'nodejs-lib-ruby-parser.wasm');
    const path = require('path').join(aaaqqq, 'nodejs-lib-ruby-parser.wasm');
...
//# sourceMappingURL=nodejs-lib-ruby-parser.js.map