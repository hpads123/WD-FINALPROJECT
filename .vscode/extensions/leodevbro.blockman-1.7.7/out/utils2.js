...
const updateRender = ({ editorInfo, timer, supMode }) => {
    if (!extension_1.glo.isOn ||
        (extension_1.glo.blackListOfFileFormats.actsAsWhiteList !== true
            ? // act as black list of file formats
                extension_1.glo.blackListOfFileFormats.formatArr.includes(editorInfo.editorRef.document.languageId)
